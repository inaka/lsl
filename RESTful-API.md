...
3. Check the match status to see if it's your turn ([``GET /matches/:match_id``](#get-matches-match_id))
4. When it's your turn, play ([``PATCH /matches/:match_id``](#patch-matches-match_id))
...
4. Play ([``PATCH /matches/:match_id``](#patch-matches-match_id]))
5. If you haven't won yet, check the match status ([``GET /matches/:match_id``](#get-matches-match_id))
6. If you haven't lost yet, repeat from _4_

#### Voluntarily invalidating a session
1. Delete the session ([``DELETE /sessions/:session_id``](#delete-sessions-session_id))

#### Delete an Account
1. Delete the player ([``DELETE /players/:player_id``](#delete-players-player_id))

#### Cancelling a Match
1. Delete the match ([``DELETE /matches/:match_id``](#delete-matches-match_id))
